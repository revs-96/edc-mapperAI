...
export const useTrainer = (apiBase, addActivity, updateKnowledgeStats, setModelReady, setStatusMsg, setLoading, setError) => {
  ...
  const handleTrain = async () => {
    ...
    try {
      ...
      addActivity('train', `Model trained from ${trainFiles.odm.name}`);
